...
describe 'GET request' do
  describe 'user visits /api/v1/parking' do
    it 'shows curb details for legal parking spot' do
      VCR.use_cassette('legal_parking') do
        lat = 37.8027568
        lon = -122.4057935
    ...
    it 'shows a message that parking is not permitted in an  illegal parking spot' do
      VCR.use_cassette('illegal_parking') do
        lat = 47.606364
        lon = -122.334435
        get api_v1_parking_path(latitude: lat, longitude: lon)
        ...
        message_result = "You cannot legally park here."
    ...
    it 'does not show curb details for unrecognized coordinates' do
      VCR.use_cassette('no_curb_data') do
        ...
        message_result = "Please select another location. The location you supplied is not in a city we have curb data for. To see the list of cities we support, visit https://coord.co/locations."
